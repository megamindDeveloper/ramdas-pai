...
const BirthdayGreetingCard: React.FC<BirthdayGreetingCardProps> = ({ onClose }) => {
  ...
  return (
    ...
    <div className="relative font-sans bg-[#fdf3de] text-[#4a2e20] max-w-3xl  mx-auto my-8 p-8 pt-12 rounded-lg border-2 border-[#a98e71] shadow-2xl overflow-hidden">
      ...
      <button
        onClick={onClose}
        className="absolute top-3 cursor-pointer right-3 bg-[#002c5a] text-white px-4 py-1 rounded-md text-sm font-semibold z-10 hover:bg-opacity-90 transition-opacity"
      >
