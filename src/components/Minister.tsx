    ...
    <div className="mx-auto container pt-12 lg:py-16 px-5 lg:px-0 overflow-hidden rounded-3xl lg:max-w-7xl">
      <div className="relative  hidden mb-8 rounded-lg aspect-video bg-black z-10 cursor-pointer">
        {!mobileIsPlaying ? (
          ...
          <iframe
            ...
            src="https://www.youtube.com/embed/zgy_IF8gGvE?si=IQs2exCVPW4SvIlh?si=cztHFf8t0m32LCIR?autoplay=1&rel=0"
      ...
      <div className="">
        <h2 className="font-helvetica text-black   font-medium leading-[1.2] lg:leading-none text-[34px]  lg:text-[44px]">
          <AnimatedTextCharacter text="Union Minister of Consumer Affairs" className="font-sans hidden md:block" />
          <AnimatedTextCharacter text="Union Minister of" className="font-sans md:hidden" />
          <AnimatedTextCharacter text="Consumer Affairs" className="font-sans md:hidden" />
        </h2>
        <h2 className="font-helvetica text-black  tfont-medium leading-none text-[34px]  lg:text-[44px] my-4">
          <AnimatedTextCharacter text="Prahlad Joshi" className="text-[#EF4123] font-serif" />
        </h2>
        <p
          ref={textAnimation1}
          className={`font-sans  text-base  text-black  lg:text-[18px]  mx-auto text- max-w-7xl mt-4 ${text1InView ? "text-slide-in" : ""}`}
        >
          Shri Prahlad Joshi, Hon’ble Union Minister of Consumer Affairs, Food & Public Distribution, and Minister of New & Renewable Energy, conveys his best wishes to Dr. Ramdas M. Pai on his birthday, paying tribute to his exemplary vision, transformative contributions to healthcare and education, and his enduring legacy of nation-building.
        </p>
      </div>
      <div className="relative  mt-8 overflow-hidden aspect-video bg-black z-10">
        {!isPlaying ? (
          <div onClick={() => setIsPlaying(true)} className="relative w-full h-full cursor-pointer">
            <Image
              loading="lazy"
              width={1000}
              height={1000}
        ...
        <iframe
  className="w-full h-full cursor-pointer"
  src="https://www.youtube.com/embed/zgy_IF8gGvE?autoplay=1&rel=0&si=IQs2exCVPW4SvIlh"
  title="GLC 2024 Experience"
  frameBorder="0"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
  allowFullScreen
