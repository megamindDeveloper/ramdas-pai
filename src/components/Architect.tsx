...
const Architect = () => {
  ...
  return (
     <div className="mx-auto container py-20 overflow-hidden rounded-3xl lg:max-w-6xl">
          ...
          <p className="text-[#E8590C]  font-helvetica text-2xl text-center mb-5">The Architect of Modern Manipal</p>
          ...
          >
            ...
            innovative thinking, and visionary approach have shaped generations of learners, thus transforming Manipal into a beacon of global
            education with the noblest of ideals.
          </p>
