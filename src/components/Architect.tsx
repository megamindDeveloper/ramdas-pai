    ...
    <div className="mx-auto container pt-12 lg:py-16 px-5 lg:px-0 overflow-hidden rounded-3xl lg:max-w-7xl">
      ...
      <div className="">
        ...
        >
          ...
          where Manipal stands among the world’s premier educational institutions. Dr. Pai’s extraordinary leadership, innovative thinking, and
          visionary approach have shaped generations of learners, transforming Manipal into a beacon of global education with the noblest of ideals.
        </p>
      </div>
